    ...
    <div class="jumbotron">
        <table class="table table-responsive table-bordered">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAno2Receita" runat="server" TextMode="Number">79000</asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtAno1Receita" runat="server" TextMode="Number">76000</asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAno2CustoVendas" runat="server" TextMode="Number">28000</asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtAno1CustoVendas" runat="server" TextMode="Number">25000</asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td class="auto-style1">
                    <asp:TextBox ID="txtAno2DespesasVendas" runat="server" TextMode="Number">6200</asp:TextBox>
                </td>
                <td class="auto-style1">
                    <asp:TextBox ID="txtAno1DespesasVendas" runat="server" TextMode="Number">5500</asp:TextBox>
                </td>
                <td class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAno2DespesasAdministrativas" runat="server" TextMode="Number">9000</asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtAno1DespesasAdministrativas" runat="server" TextMode="Number">8300</asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAno2DespesasFinanceiras" runat="server" TextMode="Number">1800</asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtAno1DespesasFinanceiras" runat="server" TextMode="Number">1900</asp:TextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtAno2ImpostoRenda" runat="server" TextMode="Number">8500</asp:TextBox>
                </td>
                <td>
                    <asp:TextBox ID="txtAno1ImpostoRenda" runat="server" TextMode="Number">8825</asp:TextBox>
                </td>
                <td>
